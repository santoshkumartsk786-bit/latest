# ============================================================================
# MOVIE REVIEW SENTIMENT ANALYSIS - STREAMLIT APP (FIXED)
# Save as: app.py
# ============================================================================
...
# ============================================================================
# TEXT PREPROCESSOR CLASS (Created fresh, not loaded)
# ============================================================================

class TextPreprocessor:
    """Text preprocessing - created fresh in app"""
    def __init__(self):
        self.lemmatizer = WordNetLemmatizer()
        self.stop_words = set(stopwords.words('english'))
        # Keep important negation words
        self.stop_words -= {'not', 'no', 'nor', 'neither', 'never', 'nobody', 'nothing'}
...
# ============================================================================
# LOAD MODELS (Without preprocessor.pkl)
# ============================================================================
...
def load_models():
    ...
    try:
        ...
        st.info("Required files: sentiment_lr.pkl, sample_reviews.json")
        st.info("Note: preprocessor.pkl is NOT needed - it's created automatically")
        st.stop()
    except Exception as e:
        st.error(f"❌ Error loading models: {str(e)}")
        st.info("""
        **Troubleshooting:**
        - Ensure sentiment_lr.pkl is uploaded
        - Ensure sample_reviews.json is uploaded
...
with col1:
    ...
    if st.button("🎲 Try a Random Sample"):
        if sample_reviews:
            ...
            st.session_state.sample_review = sample['review']
            st.rerun()

# Use session state for sample review
    ...
    if not review_text or len(review_text.strip()) < 10:
        ...
        with st.spinner("🤖 Analyzing review..."):
            ...
            if sentiment is None:
                st.error("Failed to analyze review. Please try again.")
            else:
                # Display results
                st.markdown("---")
                ...
                # Similar reviews
                if show_similar and sample_reviews:
                    st.markdown("---")
